...
const allCategories: Category[] = [
  { id: 'delta-force', name: '三角洲行动', type: 'article', description: '战术射击游戏', icon: '🎯', parentCategory: 'games' },
  { id: 'star-rail', name: '星穹铁道', type: 'article', description: '银河冒险之旅', icon: '🚂', parentCategory: 'games' },
  { id: 'genshin', name: '原神', type: 'article', description: '提瓦特大陆', icon: '✨', parentCategory: 'games' },

  { id: 'original-chara', name: '原创角色', type: 'image-text', description: 'OC 设定与插画', icon: '🧑‍🎨', parentCategory: 'paintings' },
  { id: 'scene', name: '场景插画', type: 'image-text', description: '风景与建筑', icon: '🏞️', parentCategory: 'paintings' },

  { id: 'anime', name: '番剧推荐', type: 'article', description: '最近看的动画', icon: '📺', parentCategory: 'acg' },
  { id: 'manga', name: '漫画速递', type: 'article', description: '追更与吐槽', icon: '📚', parentCategory: 'acg' },
  { id: 'figure', name: '手办收藏', type: 'image-text', description: '开箱与展示', icon: '🎎', parentCategory: 'acg' },

  { id: 'jpop', name: 'J-Pop', type: 'image-text', description: '流行与独立音乐', icon: '🎶', parentCategory: 'music' },
  { id: 'ost', name: '游戏OST', type: 'image-text', description: '原声音乐推荐', icon: '🎧', parentCategory: 'music' },

  { id: 'frontend', name: '前端框架', type: 'article', description: 'Vue / React', icon: '🖥️', parentCategory: 'tech' },
  { id: 'animation', name: '动画技术', type: 'article', description: 'Canvas / WebGL', icon: '🎬', parentCategory: 'tech' },
]
